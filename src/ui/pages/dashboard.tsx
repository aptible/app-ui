          ...
          <Box className="flex flex-col !p-0 overflow-hidden">
            ...
            <div className="flex flex-col gap-4 p-4">
              <div className="flex flex-row items-center pb-4 border-b border-black-100">
                <div className="flex-1 flex items-center text-base text-indigo">
                  Add SSH Keys{" "}
                  <IconArrowRight variant="sm" className="ml-1 stroke-indigo" />
                </div>
                <div className="text-base font-bold text-forest">DONE</div>
              </div>
              <div className="flex flex-row items-center pb-4 border-b border-black-100">
                <div className="flex-1 flex items-center text-base text-indigo">
                  Deploy App or Database{" "}
                  <IconArrowRight variant="sm" className="ml-1 stroke-indigo" />
                </div>
                <div className="text-base font-bold text-forest">DONE</div>
              </div>
              ...
              <div className="flex flex-row items-center">
                ...
                <div className="text-base font-bold text-gray-500">TODO</div>
              </div>
            </div>
          </Box>
        </Group>
        <Box className="w-[600px] flex flex-col !p-0 overflow-hidden">
          <div className="py-2 px-4 bg-black-50 flex flex-row items-center">
            ...
            <div class="flex">
              <button
                disabled=""
                type="button"
                class="rounded-r-none hover:z-10 pointer-events-none !bg-black-100 flex items-center justify-center px-4 py-[1.5px] text-sm font-medium border border-black-100 font-bold shadow-sm text-black bg-white hover:bg-black-100 hover:border-black-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black-200 rounded-md opacity-50"
              >
                All
              </button>
              <button
                type="button"
                class="rounded-l-none hover:z-10  flex items-center justify-center px-4 py-[1.5px] text-sm font-medium border border-black-100 font-bold shadow-sm text-black bg-white hover:bg-black-100 hover:border-black-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black-200 rounded-md"
              >
                Failed
              </button>
            </div>
          ...
          <div className="flex flex-col">
            <div className="flex flex-row gap-3 py-2 px-4 border-b border-black-100 items-center">
              ...
              <div className="break-words">
                app-ui backup restored
                <div className="text-sm text-gray-500 break-words">
                  2025-01-16 02:41:40 UTC by Mark Corrigan
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            <div className="flex flex-row gap-3 py-2 px-4 border-b border-black-100 items-center">
              ...
              />
              <div className="break-words">
                dashboard-production environment created
                <div className="text-sm text-gray-500 break-words">
                  2025-01-16 02:41:40 UTC by Mark Corrigan
                </div>
              </div>
