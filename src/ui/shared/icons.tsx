...
export const IconLock = (props: Props) => {
  return (
    <IconStrokeBase {...props} title="Restricted">
      <path d="M6 10.8V8.39999C6 6.80869 6.63214 5.28257 7.75736 4.15735C8.88258 3.03213 10.4087 2.39999 12 2.39999C13.5913 2.39999 15.1174 3.03213 16.2426 4.15735C17.3679 5.28257 18 6.80869 18 8.39999V10.8C18.6365 10.8 19.247 11.0529 19.6971 11.5029C20.1471 11.953 20.4 12.5635 20.4 13.2V19.2C20.4 19.8365 20.1471 20.447 19.6971 20.8971C19.247 21.3471 18.6365 21.6 18 21.6H6C5.36348 21.6 4.75303 21.3471 4.30294 20.8971C3.85285 20.447 3.6 19.8365 3.6 19.2V13.2C3.6 12.5635 3.85285 11.953 4.30294 11.5029C4.75303 11.0529 5.36348 10.8 6 10.8V10.8ZM15.6 8.39999V10.8H8.4V8.39999C8.4 7.44521 8.77928 6.52954 9.45441 5.85441C10.1295 5.17928 11.0452 4.79999 12 4.79999C12.9548 4.79999 13.8705 5.17928 14.5456 5.85441C15.2207 6.52954 15.6 7.44521 15.6 8.39999V8.39999Z" />
    </IconStrokeBase>
  );
};
