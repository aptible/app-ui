...
export const CostEstimateTooltip = ({
  cost,
  text = "This is an estimate of the cost of running the current resources for one month. Please note: it does not represent your actual usage for the month and does not reflect contract discounts, custom rates, or allocations.",
  ...tooltipProps
