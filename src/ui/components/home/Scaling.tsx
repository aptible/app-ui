import { formatCurrency, selectDatabasesForTableSearch } from "@app/deploy";
...
export const Scaling = () => {
  ...
  const serviceSizingPolicies = useSelector(
  ...
  const autoscaledServices = !isServicesLoading
  ...
  const servicesScaleDownSavings =
    !isServicesLoading && !isRecommendationsLoading
      ? services.reduce((total, service) => {
          ...
          const hasProfileChanged =
            service.instanceClass !== rec.instanceClassAtTime;
  ...
  const databaseScaleDownSavings = !isDatabasesLoading
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-gray-200">
          <div className="p-4 flex flex-col items-center">
            ...
            {isServicesLoading ? (
              ...
              <Link
                to="http://localhost:4200/services"
