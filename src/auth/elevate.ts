import { call, put, setLoaderStart, setLoaderError, setLoaderSuccess } from 'saga-query';
...
export const elevate = thunks.create<ElevateToken>(
  ...
  function* onElevate(ctx: ThunkCtx<ElevateToken>, next) {
    ...
    const tokenCtx: ElevateTokenCtx = yield call(elevateToken.run, elevateToken(ctx.payload));
